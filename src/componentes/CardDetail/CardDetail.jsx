...
import CardFormulario from "../CardFormulario/CardFromulario";
...
const CardDetail=()=>{
    ...
    if(datos.length>0 && name.length<1){
          ...
          return(
               <>
                ...
                <h1 className="cost">$ {datos[0].cost}</h1>

            </div><div className="container-card-detail">
                    ...
                    <div className="card-detail-propiedad">
                        <CardDetailPropiedad bedrooms={datos[0].bedrooms} bathroom={datos[0].bathroom} slot={datos[0].slot} year={datos[0].year} />
                    </div>
                </div>
    ...
    <div className="container-card-detail">
            ...
            <div className="card-detail-propiedad">
                <CardDetailPropiedad bedrooms={name.bedrooms} bathroom={name.bathroom} slot={name.slot} year={name.year} />
            </div>
